...
$user_id=null;
$sql1 = "SELECT * FROM documento WHERE iddocumento=10";
...
<form role="form" id="actualizar" >
  ...
  <div class="col-md-4">
    ...
    <?php echo $person->fechaemision; ?>
<br>
    <label for="address">F. Documento</label>
    <?php echo $person->fechadocumento; ?>
    <br>
    <label for="address">Descripcion</label>
    <?php echo $person->dscdocumento; ?>
...
<center><button onclick="window.print()" type="submit" class="btn btn-primary">Imprimir</button></center>
