<?php
		...
		$sql1= "SELECT idusuario,dsctipousuario,nombreusu,apellidousu,usuariologin,contrasena,email,celular,direccion,dscestado from usuario INNER JOIN tipousuario on usuario.idtipousuario=tipousuario.idtipousuario INNER JOIN estado on usuario.idestado=estado.idestado where nombreusu like '%$_GET[s]%' or apellidousu like '%$_GET[s]%' or email like '%$_GET[s]%' limit $startpage,$limitpage";
