...
$sql1= "SELECT * from empleados 
    INNER JOIN tipoempleado on empleados.idtipoempleado=tipoempleado.idtipoempleado 
    INNER JOIN tipocargo on empleados.idtipocargo=tipocargo.idtipocargo 
    INNER JOIN tipopago on empleados.idtipopago=tipopago.idtipopago
    INNER JOIN tipopension on empleados.idtipopension=tipopension.idtipopension
    INNER JOIN tiposeducacion on empleados.idtiposeducacion=tiposeducacion.idtiposeducacion
    INNER JOIN tipovinculo on empleados.idtipovinculo=tipovinculo.idtipovinculo
...
<?php while ($r=$query->fetch_array()):?>
	...
	<td style="width:150px;">
		...
		function(p){ 
			...
			swal("¡Hecho!",
		"Acabas de eliminar un empleado.",
		"success");
	}
		});
